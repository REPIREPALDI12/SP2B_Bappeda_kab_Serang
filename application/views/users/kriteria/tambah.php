                  ...
                  <div class="form-group">
                    ...
                    <div class="col-lg-9">
                      <select class="form-control default-select2" name="field" required>
                        <?php echo $this->Mcrud->sel_option('field_k'); ?>
                      </select>
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="col-lg-9">
                      <input type="text" name="nama_kriteria" class="form-control" value="" placeholder="Nama Kriteria" required autofocus onfocus="this.value = this.value;">
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="control-label col-lg-3">Bobot</label>
                    <div class="col-lg-9">
                      <input type="text" name="bobot" class="form-control" value="" placeholder="Bobot" maxlength="5" required>
                    </div>
                  </div>
                  <hr>
