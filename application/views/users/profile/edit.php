            ...
            <div class="panel-body">
                ...
                <form class="form-horizontal" action="" data-parsley-validate="true" method="post" enctype="multipart/form-data">
                  <div class="form-group">
                    ...
                    <div class="col-lg-11">
                      <input type="text" name="judul" class="form-control" value="<?php echo $query->judul; ?>" placeholder="Judul" required autofocus onfocus="this.value = this.value;">
                    </div>
                  </div>
                  <div class="form-group">
                    <div class="col-lg-12" style="border:1px solid #f1f1f1;padding:5px;">
                      <textarea name="ket" class="form-control" id="wysihtml5" rows="8" cols="80" placeholder="Keterangan" required><?php echo $query->ket; ?></textarea>
                    </div>
                  </div>
                  <hr>
