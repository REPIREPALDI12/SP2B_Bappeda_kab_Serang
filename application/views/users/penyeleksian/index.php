						                  ...
						                  <div class="form-group"> <b>Sampai dengan Tanggal</b>
						                    <div class="input-group">
						                      ...
						                      <input type="text" name="tgl2" id="tgl_2" class="form-control daterange-single" value="<?php echo $tgl2; ?>" maxlength="10" required>
														...
														<div class="col-md-4">
															<br>
													  	<a href="<?php echo $link1; ?>/<?php echo $link2; ?>/<?php echo $link3; ?>/<?php echo $link4; ?>/t.html" class="btn btn-primary" style="float:right;"><i class="fa fa-clipboard"></i> Tambah</a>
															<a href="<?php echo $link1; ?>/<?php echo $link2; ?>/<?php echo $link3; ?>/<?php echo $link4; ?>/grafik.html" class="btn btn-info" style="float:right;margin-right:10px;"><i class="fa fa-bar-chart-o"></i> Grafik</a>
															<!-- <a href="<?php echo $link1; ?>/<?php echo $link2; ?>/<?php echo $link3; ?>/<?php echo $link4; ?>/excel.html" class="btn btn-success" style="float:right;margin-right:10px;"><i class="fa fa-file-excel-o"></i> Download</a> -->
		                        </div>
													</div>
													<hr>
                                        ...
                                        <td><b><?php echo $no++; ?>.</b> </td>
																				...
																				<td align="center">
																					<?php if ($data_nilai->num_rows()==0){ ?>
																						...
																						<a href="javascript:;" class="btn btn-success btn-xs" title="Edit" disabled><i class="fa fa-pencil"></i></a>
	                                          <a href="javascript:;" class="btn btn-danger btn-xs" title="Hapus" disabled><i class="fa fa-trash-o"></i></a>
	                                        <?php }else{ ?>
																						<a href="<?php echo $link1; ?>/<?php echo $link2; ?>/<?php echo $link3; ?>/<?php echo $link4; ?>/d/<?php echo hashids_encrypt($baris->id_karyawan); ?>" class="btn btn-info btn-xs" title="Detail"><i class="fa fa-list"></i></a>
																						<a href="<?php echo $link1; ?>/<?php echo $link2; ?>/<?php echo $link3; ?>/<?php echo $link4; ?>/ne/<?php echo hashids_encrypt($baris->id_karyawan); ?>" class="btn btn-success btn-xs" title="Edit"><i class="fa fa-pencil"></i></a>
	                                          <a href="<?php echo $link1; ?>/<?php echo $link2; ?>/<?php echo $link3; ?>/<?php echo $link4; ?>/h/<?php echo hashids_encrypt($baris->id_karyawan); ?>" class="btn btn-danger btn-xs" title="Hapus" onclick="return confirm('Anda yakin?');"><i class="fa fa-trash-o"></i></a>
	                                        <?php } ?>
																				</td>
                                    </tr>
                                  <?php
    ...
    $('#tgl_1').datetimepicker({
      ...
      format:'d-m-Y'
		...
		function tampilkan()
		{
			...
			window.location.href = "penyeleksian/v/"+tgl1+"/"+tgl2;
		}
    </script>
