                  ...
                  <table id="penyeleksian" class="table table-bordered table-striped" width="100%" >
                    <thead>
                      <tr>
                        ...
                        <th id="bg" width="110">Bobot Kriteria</th>
                        <th id="bg" width="1%"></th>
                    ...
                    <tbody>
                      ...
                      foreach ($v_kriteria->result() as $key => $value):
                        ...
                        <tr>
                          ...
                          <td><b>X</b> </td>
                          <td><input type="text" name="nilai_<?php echo $value->id_kriteria; ?>" value="" onkeyup="return hitung('<?php echo $value->id_kriteria; ?>');" class="form-control" placeholder="Input Nilai" maxlength="5" style="text-align:center;width:100px;" <?php if($no==1){echo "autofocus";} ?> required></td>
                          <td align="center" id="jumlah_<?php echo $value->id_kriteria; ?>" class="jumlah" style="font-weight:bold">0</td>
                        </tr>
                      <?php
                      $no++;
                      $t_bobot += $value->bobot;
                    ...
                    <tfoot>
                      <tr>
                        ...
                        <td></td>
                        <td></td>
                        <td align="center" id="total" style="background:#F1D51B;font-weight:bold">0</td>
                      </tr>
                    </tfoot>
                  </table>
                  <hr>
                  <a href="<?php echo $link1; ?>/<?php echo $link2; ?>/<?php echo $link3; ?>/<?php echo $link4; ?>/t.html" class="btn btn-default"><< Kembali</a>
        ...
        function hitung(id){
          ...
          $.ajax({
           ...
           success: function(data){
             jumlah.html(data.jumlah.toFixed(2));
             total();
           },
